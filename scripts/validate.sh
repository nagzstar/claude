...
paths allow fullstack "$N/app/src/pages/X.tsx"
paths allow fullstack "$N/supabase/migrations/x.sql"
paths allow fullstack "$N/app/src/contexts/AuthContext.tsx"
paths block fullstack "$N/.github/workflows/deploy.yml"
paths block fullstack "$root/CLAUDE.md"
paths block fullstack "$N/.agent-context/security-model.md"
